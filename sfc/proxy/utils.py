...
def decode_cidr(cidr):
    """
    This function converts cidr to network and netmask

    @param cidr: string representation of cidr
    @return: return array of network and netmask elements
    """
