...
#from nscs.crdservice.agent.linux import ovs_lib
...
#from nscs.crdservice.plugins.nwservices.agent import remote_control
from sfc.crdservice.agents import remote_control
...
def main():
    ...
    LOG.info(_("username= %s,password=%s,auth_url=%s"),cfg.CONF.nscs_authtoken.admin_user,cfg.CONF.nscs_authtoken.admin_password,cfg.CONF.nscs_authtoken.auth_url)
