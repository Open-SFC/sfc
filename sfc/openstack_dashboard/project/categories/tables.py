...
class DeleteCategory(CheckCategoryEditable, tables.DeleteAction):
    ...
    def delete(self, request, category_id):
        try:
            ...
            api.sfc.category_delete(request, category_id)
...
class CreateCategory(tables.LinkAction):
    ...
    url = "horizon:project:categories:create"
...
class EditCategory(CheckCategoryEditable, tables.LinkAction):
    ...
    url = "horizon:project:categories:update"
    classes = ("ajax-modal", "btn-edit")


def get_networkfunctions(category):
    template_name = 'project/categories/_category_networkfunctions.html'
    context = {"category_networkfunctions": category.category_networkfunctions}
...
class CategoriesTable(tables.DataTable):
    ...
    category_networkfunctions = tables.Column(
        get_networkfunctions, verbose_name=_("Network Functions Associated"),)
