...
"""
Views for managing Crd Vendors.
"""
import logging
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'project/vendors/index.html'

    def get_data(self):
        try:
            tenant_id = self.request.user.tenant_id
            vendors = api.sfc.vendor_list_for_tenant(self.request,
                                                     tenant_id)
        except:
            vendors = []
...
class CreateVendorView(forms.ModalFormView):
    ...
    template_name = 'project/vendors/create.html'
    success_url = reverse_lazy('horizon:project:vendors:index')


class UpdateVendorView(forms.ModalFormView):
    form_class = UpdateVendor
    template_name = 'project/vendors/update.html'
    ...
    def _get_object(self, *args, **kwargs):
        if not hasattr(self, "_object"):
            ...
            try:
                self._object = api.sfc.vendor_get(self.request,
                                                  vendor_id)
            except:
