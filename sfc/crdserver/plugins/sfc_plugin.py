...
from nscs.crdserver.openstack.common.gettextutils import _
from sfc.crdserver.db import sfc_db
from sfc.crdserver.extensions.sfcext import SFCPluginBase
from sfc.crdserver.common import constants
from sfc.crdserver.drivers.fsl_driver import SFCDriver
from sfc.crdserver.listener.sfc import SFCListener
from sfc.crdserver.plugins import delta
from sfc.crdserver.common import exceptions as sfc_exc
from nscs.crdserver.common import exceptions
...
class SFCPlugin(SFCPluginBase, SFCListener):
    ...
    def create_chain_appliance_instance(self, context, chain_appliance_map_instance):
        v = self.db.create_chain_appliance_map_instance(context, chain_appliance_map_instance)
	return data
